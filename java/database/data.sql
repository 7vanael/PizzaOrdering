...
VALUES ('Pepperoni', 1, 'Meat', ''), ('Basil', 1, 'Veggie', ''), ('Italian Sausage', 2, 'Meat', ''), ('Mushrooms', 0, 'Veggie', ''),
 ...
 ('Fresh Mozzarella cheese', 2, 'Cheese', ''), ('BBQ chicken', 2, 'Meat', ''), ('Regular', 0, 'Crust', 'Garlic seasoned crust with a rich, buttery taste'), ('Deep Dish', 0, 'Crust', 'Chicago-style deep dish crust with a buttery, flaky exterior'),
 ('Thin', 0, 'Crust', 'Thin enough for optimum crispy to crunchy ratio'), ('Cauliflower', 0, 'Crust', 'Gluten-free cauliflower crust with a buttery flaky exterior'), ('Tomato', 0, 'Sauce', ''), ('Pesto', 0, 'Sauce', ''), ('Pineapple', 2, 'Veggie', ''),
 ('Alfredo', 0, 'Sauce', ''), ('BBQ', 0, 'Sauce', ''), ('Small', 0, 'Size', ''), ('Medium', 0, 'Size', ''), ('Large', 0, 'Size', ''),
 ('Banana Peppers', 1, 'Veggie', '');
